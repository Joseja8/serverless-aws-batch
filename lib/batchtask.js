        ...
        this.serverless.service.functions,
        {
            [functionName]: {
                ...
                environment: {
                    ...
                    TAG_TEAM: _.get(functionObject, 'tags.team', _.get(this.serverless.service, 'provider.tags.team', '')),
                    TAG_PROJECT: _.get(functionObject, 'tags.project', _.get(this.serverless.service, 'provider.tags.project', '')),
                    TAG_ENV: _.get(functionObject, 'tags.env', _.get(this.serverless.service, 'provider.tags.env', '')),
...
function updateContainerProperties(newFunction, functionObject, functionName) {
    ...
    _.set(newFunction, 'Properties.ContainerProperties.NetworkConfiguration.AssignPublicIp', 'ENABLED');
