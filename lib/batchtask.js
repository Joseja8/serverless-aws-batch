...
function compileBatchTask(functionName) {
    ...
    // Merge JobDefinition containerProperties->networkConfiguration->assignPublicIp to ENABLED.
    // This is required for the container to be able to access the internet.
    // https://docs.aws.amazon.com/batch/latest/userguide/assign-public-ip.html
    _.set(new
        Function, 'Properties.ContainerProperties.NetworkConfiguration.AssignPublicIp', 'ENABLED');
