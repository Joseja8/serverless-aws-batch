...
function buildDockerImage() {
    ...
    FROM FROM public.ecr.aws/lambda/${this.serverless.service.provider.runtime} AS builder
    USER root
    ...
    #RUN cd /tmp && unzip -q pythonRequirements.zip && rm pythonRequirements.zip
