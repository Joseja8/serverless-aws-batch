...
function buildDockerImage() {
    ...
    const dockerFileContents =
        `
    FROM public.ecr.aws/shogo82148/lambda-python:build-3.13 AS builder
    USER root
    ...
    FROM public.ecr.aws/shogo82148/lambda-python:3.13
    ...
    const dockerOptions = ['build', '--platform', 'linux/amd64', '-f', dockerFile, '-t', this.provider.naming.getDockerImageName(), '.'];
